    ...
    <div className='w-full h-full bg-white py-7' id='About'>
      <div className='flex flex-col max-w-[1340px] mx-auto w-full'>
        <div className='flex md:flex-row-reverse flex-col-reverse w-[90%] mx-auto md:items-center gap-10'>
          <div className='flex flex-col text-gray-700 justify-between'>
          ...
          <img src={meeting} className='p-10 max-w-[600px] lg:w-[600px] md:w-[400px]' alt=""/>
        </div>
        <div className='flex md:flex-row flex-col-reverse w-[90%] mx-auto md:items-center text-gray-700 gap-10'>
          ...
          <img src={laptopman} className='p-10 max-w-[600px] lg:w-[600px] md:w-[400px]' alt=""/>
        </div>
      </div>
    </div>
  )
